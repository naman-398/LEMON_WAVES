...
import { Righticon } from '../CommonIcon/Icon';
...
const Readysection = () => {
  ...
  const toggleSwitch = () => {
    ...
    return (
        <div id='about' className=' max-w-[1121px] mx-auto px-3 mt-[40px] 576:mt-[50px] md:mt-[90px] 992:mt-[133px] overflow-hidden'>
            ...
            <p className=' font-poppins text-[#000] font-semibold leading-[36px] 450:leading-[50px] 576:leading-[60px] text-center text-[28px] 450:text-[40px] 576:text-[50px] mx-auto max-w-[650px]'  data-aos="fade-left">Ready to get started with
                Lemon Wares?</p>
            <p className=' text-center font-poppins text-[16px] 450:text-[22px] 576:text-[25px] leading-[25px] text-[#000] font-normal mt-[10px] 576:mt-[38px]'   data-aos="fade-right">Choose the package that suits you</p>
            <div className=' flex items-center mx-auto 450:justify-center mt-[15px] 576:mt-[30px] md:mt-[57px] justify-between max-w-[300px] 450:max-w-[unset]'  data-aos="fade-left">
      ...
      <div className="relative">
        ...
        <div
          className={`absolute w-[22px] 450:w-[30px] h-[22px] 450:h-[30px] bg-white rounded-full shadow inset-y-0 top-[6px] 450:top-[10px] duration-300 ${
            isChecked ? ' translate-x-[37px] 450:translate-x-[43px]' : 'translate-x-0'
          }`}
        ></div>
        </div>
    ...
    <button className=' block 450:hidden mx-auto mt-[8px] font-poppins text-[10px] leading-[9px] font-medium text-[#000] p-[7px_8px] rounded-[8px] bg-[#FFE87A]'>20%  discount</button>
            <div className=' max-w-[856px] mx-auto flex relative after:absolute after:w-full after:left-0 after:h-[4px] after:bottom-[-6px] after:bg-[#C4C4C4] mt-[20px] 576:mt-[40px] md:mt-[70px]'   data-aos="fade-right">
                <div onClick={() => tabs('tab1')} className={` ${first === "tab1" ? "tab_2 " : ""} w-[50%] flex justify-center`}>
                ...
                <div onClick={() => tabs('tab2')} className={` ${first === "tab2" ? "tab_2 " : ""} w-[50%] flex justify-center`}>
