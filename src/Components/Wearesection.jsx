...
const Wearesection = () => {
    return (
        <div id='contact' className=' overflow-hidden relative max-w-[1440px] mx-auto'>
            <span className=' absolute left-[38%] top-[0%] elipse'>
                <Heroelipse1/>
            </span>
            <span className=' absolute left-[5%] bottom-[20%] elipse'><Heroelipse3/></span>
            <span className=' absolute right-[5%] bottom-[10%] hidden 450:block elipse'><Heroelipse2/></span>
        <div className=' rounded-[16px] max-w-[1256px] mx-auto px-3 bg-[#F7FAFE] pt-[30px] 576:pt-[40px] md:pt-[80px] pb-[30px] 576:pb-[40px] md:pb-[88px] '>

            <p className=' font-poppins font-semibold  mt-[10px]  text-[24px] min-[450px]:text-[35px] 576:text-[45px] md:text-[60px] 992:text-[64px] text-[#2E2E2E] leading-[33px] min-[450px]:leading-[48px] 576:leading-[60px] md:leading-[88px] text-center mx-auto max-w-[1024px]'  data-aos="fade-right">We're here to make your website awesome.</p>
