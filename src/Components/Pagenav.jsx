            ...
            <nav className=' max-w-[1224px] mx-auto px-3 mt-[15px] 576:mt-[41px]'>
                <div className=' flex items-center justify-between'>
                    <div className=' flex items-center gap-[65.19px]'>
                        ...
                        <a href="#our" className='hidden lg:block font-poppins text-[15px] text-[#000] after:rounded-[10px] font-semibold leading-[normal] relative after:absolute after:w-0 after:h-[2px] after:bg-[#B00000] after:left-[50%] after:bottom-[-4px] hover:after:w-[80%] hover:after:left-[8%] after:duration-300'>Our Services</a>
                    </div>
                    <div className=' flex items-center gap-[33px] min-[992px]:gap-[70px] min-[1200px]:gap-[198px]'>
                        <ul className={`${show === true ? "left-0" : "left-[-100%]"} flex items-center gap-[33px] mobile-view`}>
                            <li>
                                <a onClick={mobile} href="#our" className=' block lg:hidden font-poppins text-[15px] text-[#000] font-semibold leading-[normal] relative after:absolute after:w-0 after:rounded-[10px] after:h-[2px] after:bg-[#B00000] after:left-[50%] after:bottom-[-4px] hover:after:w-[80%] hover:after:left-[8%] after:duration-300'>Our Services </a>
                            </li>
                            <li>
                                <a onClick={mobile} href="#about" className=' font-poppins text-[15px] text-[#000] font-semibold leading-[normal] after:rounded-[10px] relative after:absolute after:w-0 after:h-[2px] after:bg-[#B00000] after:left-[50%] after:bottom-[-4px] hover:after:w-[80%] hover:after:left-[8%] after:duration-300'>About </a>
                            </li>
                            <li>
                                <a onClick={mobile} href="#blog" className=' font-poppins text-[15px] text-[#000] font-semibold leading-[normal] after:rounded-[10px] relative after:absolute after:w-0 after:h-[2px] after:bg-[#B00000] after:left-[50%] after:bottom-[-4px] hover:after:w-[80%] hover:after:left-[8%] after:duration-300'>Blog&News </a>
                            </li>
                            <li>
                                <a onClick={mobile} href="#contact" className=' font-poppins text-[15px] text-[#000] font-semibold leading-[normal] after:rounded-[10px] relative after:absolute after:w-0 after:h-[2px] after:bg-[#B00000] after:left-[50%] after:bottom-[-4px] hover:after:w-[80%] hover:after:left-[8%] after:duration-300'>Contact</a>
                            </li>
                            <li>
